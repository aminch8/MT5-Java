...
public class LimitBuyOrder extends MT5RequestTemplate{
    LimitBuyOrder(String symbol,Number volume,Number price,String expiration) {
    ...
    LimitBuyOrder(String symbol,Number volume,Number price,Number stoploss,Number takeprofit) {
    ...
    LimitBuyOrder(String symbol, Number volume, Number price, Number stoploss, Number takeprofit, Date expiration) {
